...
import pt.ipleiria.estg.dei.ei.dae.project.ejbs.JwtBean;
import pt.ipleiria.estg.dei.ei.dae.project.ejbs.UserBean;
import pt.ipleiria.estg.dei.ei.dae.project.entities.User;
import pt.ipleiria.estg.dei.ei.dae.project.jwt.Jwt;
...
public class LoginService {
    ...
    public Response authenticateUser(UserDTO userDTO) {
        try {
            User user = userBean.authenticate(userDTO.getEmail(), userDTO.getPassword());
